                ...
                <div class="card-body">
                    ...
                    if(isset($_POST['updata']))
                    {
                                ...
                                <div class="row row-space">
                                    ...
                                    <input type="hidden" name="ed_id" value="<?php echo $row['id'];?>">
                                        <select name="ed_sends"  >
                                            <option   ><?php echo $row['sends'];?> </option>   
                                        </select>
                                ...
                                <div class="row row-space">
                                    ...
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="ed_currincy">
                                            <option    > <?php echo $row['currincy'];?></option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5"  value="<?php echo $row['modile'];?>" type="txet" name="ed_modile">
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <button class="btn btn--radius-2 btn--red" name="update" type="submit">تاكيد الاستلام</button>
                        </div>
                        <?php
                            }
                        } 
